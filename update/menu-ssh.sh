...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/hokagelegend2023/beta2/main/ssh/proxy3.js"
cat <<EOF > /etc/systemd/system/sshws.service
[Unit]
Description=WSenabler
Documentation=https://minato.hokagelegend.my.id
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/hokagelegend2023/beta2/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
...
Login=hokage`</dev/urandom tr -dc X-Z0-9 | head -c4`
hari="1"
Pass=1
