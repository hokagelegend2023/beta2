...
if [[ -f /etc/hokage/github/api && -f /etc/hokage/github/email && /etc/hokage/github/username ]]; then
   rec="OK"
else
    mkdir /etc/hokage/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/hokage/github/email
echo "$USERNAME1" > /etc/hokage/github/username
echo "$API1" > /etc/hokage/github/api
echo "ON" > /etc/hokage/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/ipmini/main/ipmini | awk '{print $4}' | grep $daftar)
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • HOKAGE LEGEND STORE •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e ""
read -n 1 -s -r -p "   Press any key to back on menu"
menu-ip
...
function resetipvps(){
clear
rm -f /etc/hokage/github/email
rm -f /etc/hokage/github/username
rm -f /etc/hokage/github/api
rm -f /etc/hokage/github/gitstat
echo "OFF" > /etc/hokage/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1│${NC} [INFO] PM : Hokage Legend Store / wa.me/087726917005/"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • HOKAGE LEGEND •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/hokage/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/hokage/github
    touch /etc/hokage/github/gitstat
    echo "OFF" > /etc/hokage/github/gitstat
fi

stst1=$(cat /etc/hokage/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
stst=$(cat /etc/hokage/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
