...
echo "IP=$pp" > /var/lib/hokage-pro/ipvps.conf

#THEME RED
cat <<EOF>> /etc/hokage/theme/red
BG : \E[40;1;41m
TEXT : \033[0;31m
EOF
#THEME BLUE
cat <<EOF>> /etc/hokage/theme/blue
BG : \E[40;1;44m
TEXT : \033[0;34m
EOF
#THEME GREEN
cat <<EOF>> /etc/hokage/theme/green
BG : \E[40;1;42m
TEXT : \033[0;32m
EOF
#THEME YELLOW
cat <<EOF>> /etc/hokage/theme/yellow
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME MAGENTA
cat <<EOF>> /etc/hokage/theme/magenta
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME CYAN
cat <<EOF>> /etc/hokage/theme/cyan
BG : \E[40;1;46m
TEXT : \033[0;36m
EOF
#THEME CONFIG
cat <<EOF>> /etc/hokage/theme/color.conf
blue
EOF
#install IPSEC
...
sleep 2
clear
wget https://raw.githubusercontent.com/hokagelegend2023/beta2/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/hokagelegend2023/beta2/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
wget https://raw.githubusercontent.com/hokagelegend2023/beta2/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
wget https://raw.githubusercontent.com/hokagelegend2023/beta2/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/hokagelegend2023/beta2/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
echo "   - Shadow-S WS/GRPC        : 443" | tee -a log-install.txt
echo "   - SSTP-L2TP-PPTP          : 500" | tee -a log-install.txt
echo ""  | tee -a log-install.txt
...
echo "   - Script Presented By      : HOKAGE LEGEND VPN STORE" | tee -a log-install.txt" | tee -a log-install.txt
